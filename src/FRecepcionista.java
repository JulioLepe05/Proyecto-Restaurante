 ...
 * @author edson
 */
public class FRecepcionista extends javax.swing.JFrame {
    ...
    public FRecepcionista() {
        ...
        if (cnx.conectar("localhost", "restaurante", "root", "") == 1) {
            cnx.entablar("SELECT * FROM clientes", tRegistros, 20, 40, 40);
    ...
    private void initComponents() {
        ...
        tfTelefono.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Recepcion cc = new Recepcion(clienteid, nombre, telefono);
        if (nombre.isEmpty() || telefono.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Por favor llene todos los campos solicitados");
        } else {

            if (cc.insertar(cnx) == 1) {
                cnx.entablar("SELECT * FROM clientes", tRegistros, 20, 40, 40);
            } else {
                JOptionPane.showMessageDialog(this, "No se pudo registrar al Propietario");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FRecepcionista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FRecepcionista().setVisible(true);
            }
        });
    }
