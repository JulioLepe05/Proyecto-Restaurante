...
public class Conexion {
    ...
    //-------- si el resultado es un objeto nulo, significa que la consulta ha
    //-------- regresado una tabla vacia o el código SQL es incorrecto
    //--------------------------------------------------------------------------
    public Object obtenerValor(String consulta) {
        ...
        try {
            ...
            ResultSetMetaData rsm = rs.getMetaData();
            while (rs.next()) {
                if (rsm.getColumnType(1) == -4) { //tipo blob de imagen
...
//---------------------------------------------------------------------------
    ...
    //--------------------------------------------------------------------------
    //-------- obtener la fecha Date a partir de una cadena SQL
    //--------------------------------------------------------------------------
    public Date ObtenerFecha(String fechaSQL) {
        String partes[] = fechaSQL.split("-");
        int aa = Integer.parseInt(partes[0]) - 1900;
        int mm = Integer.parseInt(partes[1]) - 1;
    ...
    public int ejecutarReporte(String archivo, Map parametro) {
        try {
            ...
            System.out.println("Reporte:" + j.getMessage());
            return 0;
        }
    }
// </editor-fold>
